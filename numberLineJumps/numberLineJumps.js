...
function kangaroo(x1, v1, x2, v2) {
    ...
    let kanOnePosition = x1;
    let kanTwoPosition = x2;
    let samePosition = false;
    let finded;
    
    while(kanOnePosition <= 100000000 && kanTwoPosition <= 100000000 && samePosition != true){
        kanOnePosition += v1;
        kanTwoPosition += v2;
        
        if(kanOnePosition === kanTwoPosition){
            samePosition = true
        }
    }
    
    samePosition ? finded = 'YES' : finded = 'NO'
